...
const headCells = [
  { id: 'weekEnding', numeric: false, disablePadding: true, label: 'WeekEnding' },
  { id: 'retailSales', numeric: true, disablePadding: false, label: 'RetailSales' },
  { id: 'wholesaleSales', numeric: true, disablePadding: false, label: 'WholesaleSales' },
  { id: 'unitsSold', numeric: true, disablePadding: false, label: 'UnitsSold' },
  { id: 'retailerMargin', numeric: true, disablePadding: false, label: 'RetailerMargin' },
...
export default function EnhancedTable() {
  ...
  const [orderBy, setOrderBy] = React.useState('weekEnding');
                ...
                .map((row, index) => {
                  return (
                    ...
                    >
                      ...
                      <TableCell padding="1px" >{row.weekEnding}</TableCell>  
